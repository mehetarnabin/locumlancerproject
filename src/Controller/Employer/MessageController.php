...
class MessageController extends AbstractController
{
    ...
    public function new(
        ...
        // Find employer by user relationship
        $employer = $em->getRepository(Employer::class)->findOneBy(['user' => $user]);

        if (!$employer) {
            if ($request->isXmlHttpRequest()) {
                return new JsonResponse(['error' => 'No employer profile found'], 400);
            }
            $this->addFlash('error', 'Please complete your employer profile before sending messages.');
        ...
        if ($request->isMethod('POST')) {
            ...
            return $this->redirectToRoute('app_employer_messages', $redirectParams);
        }
    ...
    #[Route('/messages/{id}/delete', name: 'app_employer_message_delete', methods: ['POST', 'DELETE'])]
    ...
    #[Route('/messages/draft/save', name: 'app_employer_draft_save', methods: ['POST'])]
    ...
    #[Route('/messages/draft/{id}', name: 'app_employer_draft_load', methods: ['GET'])]
    public function loadDraft(Message $message, EntityManagerInterface $em): JsonResponse
    {
        ...
        if ($message->getAttachment()) {
            ...
            $attachmentInfo = [
                ...
                'download_url' => $this->generateUrl('app_employer_message_attachment', ['filename' => $message->getAttachment()])
            ];
        }
    ...
    #[Route('/messages/draft/{id}', name: 'app_employer_draft_delete', methods: ['DELETE'])]
    ...
    #[Route('/messages/drafts/count', name: 'app_employer_drafts_count', methods: ['GET'])]
    ...
    #[Route('/messages/{id}/forward-data', name: 'app_employer_message_forward_data', methods: ['GET'])]
    ...
    #[Route('/messages/{id}/reply', name: 'app_employer_message_reply_ajax', methods: ['POST'])]
    ...
    #[Route('/messages/trash/count', name: 'app_employer_trash_count', methods: ['GET'])]
    ...
    #[Route('/messages/restore/{id}', name: 'app_employer_message_restore', methods: ['POST'])]
    ...
    #[Route('/messages/permanent-delete/{id}', name: 'app_employer_message_permanent_delete', methods: ['DELETE'])]
    ...
    // Empty trash
    #[Route('/messages/empty-trash', name: 'app_employer_empty_trash', methods: ['DELETE'])]
    ...
    #[Route('/message/{id}/mark-read', name: 'app_employer_message_mark_read', methods: ['POST'])]
    ...
    #[Route('/messages/{id}/forward-thread', name: 'app_employer_message_forward_thread', methods: ['GET', 'POST'])]
    public function forwardThread(
        ...
        if ($request->isMethod('POST')) {
            ...
            return $this->redirectToRoute('app_employer_messages', ['type' => 'sent']);
        }

        // For GET request, show the forward form
        return $this->render('employer/message/forward.html.twig', [
            'message' => $rootMessage,
            'thread_messages' => $threadMessages,
            'forward_thread' => true,
            'providers' => $providers,
    ...
    #[Route('/messages/{id}/forward-message', name: 'app_employer_message_forward', methods: ['GET', 'POST'])]
    ...
    // Download attachment
    #[Route('/messages/attachment/{filename}', name: 'app_employer_message_attachment', methods: ['GET'])]

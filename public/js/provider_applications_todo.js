    ...
    try {
      ...
      function routeByAction(action) {
        ...
        if (a.indexOf('review') !== -1) {
          if (appId) { navigate(window.location.origin + '/provider/' + appId + '/review-employer'); return true; }
        }
      ...
      if (iconType === 'interview') {
        ...
        if (iconType === 'credentialing') {
          return;
        }
        if (iconType === 'review') {
          if (appId) { window.location.href = window.location.origin + '/provider/' + appId + '/review-employer'; return; }
        }
        if (typeof e.preventDefault === 'function') e.preventDefault();
        if (typeof e.stopPropagation === 'function') e.stopPropagation();
        if (typeof e.stopImmediatePropagation === 'function') e.stopImmediatePropagation();
